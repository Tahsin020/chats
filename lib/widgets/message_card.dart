          ...
          return ListView(
            ...
            children: [
                  ...
                  ? _OptionItem(
                      ...
                      onTap: () async {
                        await Clipboard.setData(ClipboardData(text: widget.message.msg)).then((value) {
                          ...
                          Dialogs.showSnackbar(context, 'Metin kopyalandı!');
                        });
                      })
                  : _OptionItem(
                      ...
                      onTap: () async {
                        try {
                          ...
                          await GallerySaver.saveImage(widget.message.msg, albumName: 'IŞIK CHAT').then((success) {
                            Navigator.pop(context);
              ...
              _OptionItem(
                  ...
                  name: 'Gönderme tarihi: ${Dateutil.getMessageTime(context: context, time: widget.message.sent)}',
                  onTap: () {}),
              _OptionItem(
                  icon: const Icon(Icons.remove_red_eye, color: Colors.green),
                  name: widget.message.read.isEmpty
                      ? 'Okunma Tarihi: Henüz Görülmedi'
                      : 'Okunma Tarihi: ${Dateutil.getMessageTime(context: context, time: widget.message.read)}',
                  onTap: () {}),
            ],
          );
        });
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
              ...
              actions: [
                ...
                _updateButton(updatedMsg)
              ],
            ));
  }

  MaterialButton _updateButton(String updatedMsg) {
